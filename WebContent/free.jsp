			...
			<div class="tab-pane active" id="free">
				<div class="container">
					<div class="row">
						...
						<%
							} if(freeDAO.nextPage(pageNumber)){
								int i=1;
								while(freeDAO.nextPage(i)){
									if(i==pageNumber){
								%>
						<a href="free.jsp?pageNumber=<%=i %>" class="btn btn-primary"><%=i %></a>
						<%	
									}	else{
										%>
						<a href="free.jsp?pageNumber=<%=i %>" class="btn btn-alert"><%=i %></a>
						<%
								}
									i++;
								}
